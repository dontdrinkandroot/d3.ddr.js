...
var Point = require('../../src/geometry/rectangle.js');

test('Rectangle.Construction', function (t) {
    var rect;

    rect = new Ddr.Rectangle(10, 20, 30, 40);
    ...
    rect = new Ddr.Rectangle(new Ddr.Point(10, 20), new Ddr.Point(40, 60));
    t.ok(rect.getLeftX(), 10);
    t.ok(rect.getRightX(), 40);
    t.ok(rect.getTopY(), 20);
    t.ok(rect.getBottomY(), 60);
...
test('Rectangle.Area', function (t) {
    var rect = new Ddr.Rectangle(10, 20, 30, 40);
...
test('Rectangle.Merge', function (t) {
    ...
    rect1 = new Ddr.Rectangle(10, 20, 30, 40);
    rect2 = new Ddr.Rectangle(-10, -30, 20, 20);
    rect1.merge(rect2);
...
test('Rectangle.Intersects', function (t) {
    ...
    /* On left */
    rect2 = new Ddr.Rectangle(0, 20, 10, 40);
    t.notOk(rect.intersectsRectangle(rect2));
    t.notOk(rect2.intersectsRectangle(rect));

    /* On bottom */
    rect2 = new Ddr.Rectangle(10, 0, 30, 20);
    t.notOk(rect.intersectsRectangle(rect2));
    t.notOk(rect2.intersectsRectangle(rect));

    /* On right */
    rect2 = new Ddr.Rectangle(40, 20, 10, 40);
    t.notOk(rect.intersectsRectangle(rect2));
    t.notOk(rect2.intersectsRectangle(rect));

    /* On top */
    rect2 = new Ddr.Rectangle(10, 60, 30, 10);
    t.notOk(rect.intersectsRectangle(rect2));
    t.notOk(rect2.intersectsRectangle(rect));
    ...
    /* Intersects bottom */
    rect2 = new Ddr.Rectangle(20, 0, 10, 30);
    t.ok(rect.intersectsRectangle(rect2));
    t.ok(rect2.intersectsRectangle(rect));
